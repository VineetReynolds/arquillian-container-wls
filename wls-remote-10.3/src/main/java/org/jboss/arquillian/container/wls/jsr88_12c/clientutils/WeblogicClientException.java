...
public class WeblogicClientException extends RuntimeException {
     ...
     */
    public WeblogicClientException() {
        super();
    }
     ...
     */
    public WeblogicClientException(String message) {
        super(message);
    }
     ...
     */
    public WeblogicClientException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @param cause the Throwable that caused the exception to be thrown
     */
    public WeblogicClientException(Throwable cause) {
        super(cause);
    }
